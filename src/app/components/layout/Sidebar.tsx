  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-4">
        <Image src="/favicon.svg" alt="Logo" width={75} height={75} priority />
      </div>
        ...
        <li>
          <Button
            ...
            className={`w-full flex items-center justify-between bg-gray-100 text-gray-700 hover:bg-[#CDA95F] hover:text-white transition-all duration-300 p-3 rounded-lg ${
              showProyectosSubmenu ? "bg-[#CDA95F] text-black" : ""
            }`}
            onClick={() => setShowProyectosSubmenu((prev) => !prev)}
          >
            <span className="ml-auto pr-0">
              <i className={`pi pi-chevron-${showProyectosSubmenu ? "up" : "down"}`} />
            </span>
          </Button>
            ...
            <ul className="pl-6 mt-2 space-y-2">
              <li>
                <Button
                  ...
                  onClick={() => {
                    router.push("/dashboard/proyectos/ListaProyectos");
                    setSidebarVisible(false);
                  }}
                />
              </li>
              <li>
                <Button
                  ...
                  className="w-full justify-start bg-gray-100 text-gray-700 hover:bg-[#CDA95F] hover:text-white transition-all duration-300 p-2 rounded-md"
                  onClick={() => {
                    router.push("/dashboard/proyectos/Grafico");
                    setSidebarVisible(false);
                  }}
                />
              </li>
